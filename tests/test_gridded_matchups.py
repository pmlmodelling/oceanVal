...
class TestFinal:
    ...
    def test_gridded(self):
        ...
        ecoval.matchup(sim_dir = "data/example", obs_dir = "data/evaldata", start = 2000, end = 2000,  surface = surface, bottom = [], benthic = None, cores = 1, ask = False, lon_lim = [-20, 9], lat_lim = [40, 66])
